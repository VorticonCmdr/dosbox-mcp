...
def register(server, client, add_tool, feature=None):
    ...
    add_tool(
        ...
        description=(
            ...
            "heavy-debugger build; check capabilities.debugger in "
            "dosbox_status first (or just try it - a build without one "
            "returns 501 immediately rather than accepting a breakpoint "
